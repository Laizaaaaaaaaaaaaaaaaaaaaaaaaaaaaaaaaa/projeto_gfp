...
class rotasTransacoes {
    ...
    static async novaTransacoes(req, res) {
        const {id_transacao, valor, descricao, data_transacao, data_vencimento, data_pagamento, tipo_transacao, id_conta,
            id_categoria, id_subcategoria, id_usuario, num_parcelas, parcela_atual} = req.body;

        try {

            const transacao = await BD.query(`INSERT INTO transacoes (id_transacao, valor, descricao, data_transacao,
                ...
                [id_transacao, valor, descricao, data_transacao, data_vencimento, data_pagamento, tipo_transacao, id_conta, id_categoria, id_subcategoria, id_usuario, num_parcelas, parcela_atual]);                
    ...
    static async atualizarTodosTransacoes(req, res) {
        ...
        try {
            const transacao = await BD.query(`UPDATE transacoes SET valor = $1, descricao = $2, data_transacao = $3, data_vencimento = $4,
                data_pagamento = $5, tipo_transacao = $6, id_conta = $7, id_categoria = $8, id_subcategoria = $9,
                id_usuario = $10, num_parcelas = $11, parcela_atual = $12 WHERE id_transacao = $13 WHERE id_transacao = $13`,
        ...
        try{
            ...
            ORDER BY t.data_vencimento ASC 
             ...
             const formatarDataBr = (data) => {
                if(!data) return null; 
                return new Date(data).toLocaleDateString('pt-BR') //converte a data no padrar BR 
             } 
